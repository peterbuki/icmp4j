        ...
        for (int ttl = 1; ttl <= maxTtl; ttl++) {
            ...
            final AsyncCallback<IcmpPingResponse> asyncCallback = new AsyncCallback<IcmpPingResponse>() {
                ...
                public void onFailure(final Throwable throwable) {
                    ...
                    // objectify
                    final IcmpPingResponse response = IcmpPingResponse.builder()
            ...
            // request
            final IcmpPingRequest icmpPingRequest = IcmpPingUtil.createIcmpPingRequestBuilder()
                    .withHost(request.getHost())
                    .withPacketSize(request.getPacketSize())
                    .withTtl(ttl)
